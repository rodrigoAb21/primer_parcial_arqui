    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == vista_cliente.btn_registrar) {
            ...
            if (modelo_cliente.registrar()) {
                JOptionPane.showMessageDialog(null, "Se registro un cliente");
            }else {
                JOptionPane.showMessageDialog(null, "No se pudo registrar un cliente");
            }
            ...
            if (e.getSource() == vista_cliente.btn_editar) {
                ...
                if (modelo_cliente.editar()) {
                    JOptionPane.showMessageDialog(null, "Se edito un cliente");
                }else {
                    JOptionPane.showMessageDialog(null, "No se pudo editar un cliente");
                }
                vista_cliente.limpiarCampos();
                actualizarTabla();
            } else {
